...
{
    internal class SpongebobZalgoPluginCommand : IPluginCommand
    {
        public string PluginName => "SpongebobZalgo";
        public string Command => "spongebobZalgo";
        public string Help => "!spongebobZalgo {string}";
        public IEnumerable<string> Aliases => new[] { "666bob" };
